...
void connect_to_server() {
	...
	//Otherwise, immediately log 9-digit ID to server
	else 
		dprintf(sock, "ID=%s\n", id_num);
	//If log file was provided, write this to log file as well
	if (log_file) {
